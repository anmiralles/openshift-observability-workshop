...
oc process -f ./gitops/cluster-services/ocp-gitops/01-gitops-operator.yaml \
...
oc process -f ./gitops/cluster-services/ocp-gitops/02-argocd.yaml \
...
oc process -f ./gitops/cluster-services/ocp-gitops/03-argocd-consolelink.yaml \
